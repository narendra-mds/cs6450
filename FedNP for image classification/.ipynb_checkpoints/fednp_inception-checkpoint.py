...
parser.add_argument('--experiment', default='Inception', type=str)
...
global_model = InceptionNet(num_classes=num_classes).cuda()
models = [InceptionNet(num_classes=num_classes).cuda() for i in range(args.K)]
